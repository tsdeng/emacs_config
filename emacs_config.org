...
Actually highlight current line is a bad idea. It's hard to find a color that
works with both white and dark background.
   #+BEGIN_SRC emacs-lisp
;;  (set-face-foreground 'highlight nil)
;;  (global-hl-line-mode 1)
;;  (custom-set-faces
;;   '(hl-line ((t (:inherit nil :extend t :background "color-233")))))
...
#+BEGIN_SRC emacs-lisp
  ;;Disabling this because there is a bug will cause not being
  ;; able to resize windows when margin is set. https://github.com/emacsorphanage/git-gutter/issues/162
  ;;(setq-default left-margin-width 2 right-margin-width 2)
#+END_SRC
** Capslock binding
Since I usually rebind Caps lock key to control, I need another binding for the Caps lock function.
#+BEGIN_SRC emacs-lisp
