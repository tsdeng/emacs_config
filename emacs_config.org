...
#+BEGIN_SRC emacs-lisp
(add-hook 'emacs-startup-hook (lambda() (message (concat "emacs init time is:" (emacs-init-time)))))
#+END_SRC
...
;;(package-activate-all) ;; might not need this line in new version of emacs.
#+END_SRC
